...
client.on("message", (message) => {
   if(message.content.toLowerCase() === "İyi Geceler") {
       message.channel.send("__<:iyigecelermesajemojisi:801762205670178867> İyi geceler Güzellik <:iyigecelermesajemojisi:801762205670178867>__")
   }
   if(message.content.toLowerCase() === "Selam") {
    message.channel.send("__ <:hgmesajemojisi:801762230902456360> Aleyküm Selam, Hoşgeldin Uzaylı <:hgmesajemojisi:801762230902456360>  __")
}
})
