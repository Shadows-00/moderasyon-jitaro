...
module.exports.execute = async (client, message, args, ayar, emoji) => {
  ...
  message.channel.send(embed.setImage("https://giphy.com/gifs/ban-banned-admin-fe4dDMD2cAU5RfEaCU").setDescription(`\`${victim.user.tag}\` üyesi ${message.author} tarafından **${reason}** nedeniyle **banlandı!**`));
