...
module.exports = async (member) => {
  ...
  .setImage("https://cdn.discordapp.com/attachments/736212915266388079/783761380641734737/C_.gif")
  .setDescription(`
<:isaret:802531879253311518> Sunucuya hoş geldin ${member}, seninle \`${member.guild.memberCount}\` kişiyiz!** 

<a:bsonsuzluk:800438132750942229> Hesabın Açılış Süresi: ${member.client.tarihHesapla(member.user.createdAt)}** 

<:ayar:802532409878118450> Hesap **${guvenilirlik ? "Tehlikeli!" : "Güvenli!"}** 

:arrow_right: Burası Bir **Ekip , Ordu** Değildir. 

💠 Sadece Takılmalık Bir Ortamdır. 

<a:bonay1:800438115407757383> İyi Eğlenceler Dilerim.
